...
<html>
    ...
    <body class="is-preload">
        ...
        <section id="banner" style="min-height: 100vh;background-image:url({{$image}});background-size:cover;background-repeat:no-repeat;">
            <header class="major">
                <h1>Nothing Here</h1>
                <p style="color: white;">I couldn't find that page. Maybe it's been moved, or maybe it never existed at all.</p>
                <!-- For my friend Charlie, who has an unhealthy obsession with 404 pages -->
                <p style="color: white;font-size: 1.1rem;"><small>(unless you were looking for the 404, in which case, you found me!)</small></p>
                <p style="color: white;font-size: 1rem;">Never fear, this error has been logged and so this URL may work again, some day.</p>
            </header>
