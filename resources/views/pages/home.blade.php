...
@section('hero')
    @component('partials.hero')
        ...
        @slot('description')
            ...
            <p>I specialise in <a href="https://laravel.com" target="_blank">Laravel</a>, and I am also proficient in <a href="#languages" class="scrolly">many other programming languages</a>.</p> 
